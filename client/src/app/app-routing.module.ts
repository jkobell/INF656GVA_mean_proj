...
const routes: Routes = [
  ...
  { path: 'admin/image-upload', component: ImageUploadComponent, canActivate: [AdminCrudAuthGuard] },
  ...
  { path: 'admin/add-listing', component: AddListingComponent, canActivate: [AdminCrudAuthGuard] },
